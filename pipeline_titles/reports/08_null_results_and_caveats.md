...
- **Style as a predictor of views** (beyond outrage and capitals). In the within-channel regression of log views on the twelve dimensions, the hooks and length (month and topic controls; `engagement_summary.csv`), every predictor other than the outrage frame has a median effect at or below 0.03 log views per SD and between 53 % and 71 % of channels on the median's side of zero. The capitals effect of document 7 is measured on the same titles without topic controls and is of the same small order.
- **Power-law audiences.** 0 of 188 video channels (document 7).
- **The channel groups as a style predictor.** ARI 0.044 (document 5): channels whose titles read left, neutral or right do not title in three styles.
