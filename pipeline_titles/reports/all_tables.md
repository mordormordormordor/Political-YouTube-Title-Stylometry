...
_Generated 2026-09-16T12:11:39+00:00 by `python -m pipeline_titles.report`. Every table below is read from `data/titles/analysis/`; the code is `pipeline_titles/`._
...
- **Stage 7, political leaning (2026-09-15).** Claude Opus, through the Claude Code CLI, labelled 12,478 titles (50 per ranked channel, 16 for the 35 channels with fewer than 50 uploads) as left, right or neither from the title text alone, twenty titles to a call in a random order so that no title was judged beside its channel's other titles. It labels 55 % of titles neither, 24 % left and 20 % right; puts all 36 self-described channels on their declared side; separates the two commentary lanes at AUC 0.990; and its channel score is reliable (split-half Spearman 0.96; the original 16-title draw and the 34 month-spread top-up titles rank the 239 ranked channels at 0.96). The commentary channels that contradict their lane are the anti-war right (Shroyer, Hinkle, Part of the Problem) and Black-media channels that attack Democrats; the interview podcasts lean right as a lane; the news lanes are mostly neither with a left tilt on the titles that do read partisan; nothing moved month to month. The right's title vocabulary is fraud, women, Democrats, woke, Kirk, California; the left's is Trump, MAGA, war, Israel, breaking, Iran, Epstein. A left / right / neither lexicon cut from the judge's own labels at |z| ≥ 1.96 recovers the ordering of channels (Spearman 0.69, out of fold) but not the title-level call (agreement 53 %, kappa 0.26): the judge reads framing, and a word list reads subjects.
