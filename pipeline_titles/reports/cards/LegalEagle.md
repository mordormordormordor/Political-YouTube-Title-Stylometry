...
Titles: 105 rows, 105 unique (repeat share 0.0%); ranked; political share 84.8%.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-02 | 15 | 0.50 | -0.20 | -0.53 | -0.45 | -0.13 | -1.17 | -0.23 | 0.19 | -0.73 | -0.91 | -1.74 | -1.44 | 0.00 | 0.67 | 0.00 |


Engagement (n = 105, R2 = 0.2961; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | -0.134 | 0.087 | 0.123 |
| F2 | 0.045 | 0.097 | 0.646 |
| F3 | 0.035 | 0.068 | 0.607 |
| F4 | -0.002 | 0.133 | 0.987 |
| F5 | -0.001 | 0.110 | 0.994 |
| F6 | 0.115 | 0.095 | 0.226 |
| F7 | -0.075 | 0.094 | 0.428 |
| F8 | -0.066 | 0.081 | 0.419 |
| F9 | 0.075 | 0.109 | 0.490 |
| F10 | -0.045 | 0.099 | 0.653 |
| F11 | 0.154 | 0.094 | 0.103 |
| F12 | -0.002 | 0.091 | 0.983 |
| outrage | -0.057 | 0.088 | 0.522 |
| humor | 0.166 | 6.246 | 0.979 |
| n_tokens | -0.027 | 0.094 | 0.772 |


Hit concentration: Gini 0.3786, top-10 % share 32.4%, power-law tail not supported vs lognormal (LR = -0.4301, p = 0.6672).


Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 15.2381 per 100, mean length 6.219 tokens.
