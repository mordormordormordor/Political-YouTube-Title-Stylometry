...
Titles: 163 rows, 163 unique (repeat share 0.0%); ranked; political share 99.4%.


Top topics: HasanAbi 2026 Events (93.2%); ICE protests in Minneapolis (1.2%); Hasan Piker Controversy (1.2%); Trump and China Relations (0.6%); Islam and Political Extremism (0.6%)
...
Nearest style neighbors: @60minutes [neutral]; @Firstpost [neutral]; @Forbes [neutral]; @ponderingpolitics [left]; @chinainsights-r2w [neutral]

Nearest topic neighbors: @Vaush [left]; @Timcast [right]; @Vox [left]; @HasanReactionsfanTwo [left]; @HasanabiClips [left]
...
Engagement (n = 163, R2 = 0.6983; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | 0.165 | 0.112 | 0.141 |
| F2 | 0.059 | 0.087 | 0.495 |
| F3 | 0.137 | 0.077 | 0.075 |
| F4 | 0.035 | 0.107 | 0.744 |
| F5 | -0.059 | 0.161 | 0.715 |
| F6 | 0.153 | 0.119 | 0.198 |
| F7 | 0.120 | 0.075 | 0.108 |
| F8 | 0.067 | 0.202 | 0.739 |
| F9 | -0.207 | 0.066 | 0.002 |
| F10 | -0.040 | 0.081 | 0.622 |
| F11 | -0.370 | 0.231 | 0.109 |
| F12 | -0.204 | 0.098 | 0.037 |
| curiosity_gap | -0.081 | 0.074 | 0.275 |
| outrage | 0.030 | 0.056 | 0.591 |
| n_tokens | 0.164 | 0.186 | 0.379 |


Hit concentration: Gini 0.2192, top-10 % share 20.2%, power-law tail not supported vs lognormal (LR = -4.3196, p = 0.0).


Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 98.773 per 100, mean length 7.5583 tokens.
