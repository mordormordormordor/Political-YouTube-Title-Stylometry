...
Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 0.0 per 100, mean length 14.1429 tokens.


## streams

Titles: 153 rows, 153 unique (repeat share 0.0%); ranked; political share 96.1%.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-02 | 17 | 0.87 | 0.75 | -0.48 | 0.89 | 0.58 | -0.60 | -0.63 | -0.40 | -0.65 | -0.78 | 1.56 | 2.59 | 0.06 | 0.82 | 0.00 |
| 2026-03 | 22 | 1.04 | 0.26 | -0.68 | 1.12 | 0.43 | -0.14 | -0.75 | 0.26 | 0.13 | -0.71 | 1.01 | 2.92 | 0.05 | 0.77 | 0.00 |
| 2026-05 | 25 | 0.94 | 1.19 | -0.36 | 0.45 | -0.11 | -0.59 | -0.55 | 0.08 | -0.39 | -0.56 | 0.95 | 0.98 | 0.04 | 0.76 | 0.00 |
| 2026-06 | 18 | 0.33 | 1.26 | -0.42 | 0.67 | -0.37 | -0.23 | -0.41 | 0.28 | 0.01 | -0.74 | 0.67 | 2.47 | 0.06 | 0.61 | 0.00 |
| 2026-08 | 22 | 0.87 | 0.86 | -0.48 | 1.02 | 0.15 | -0.14 | -0.86 | -0.21 | -0.26 | -0.26 | 1.40 | 2.22 | 0.00 | 0.73 | 0.00 |


Engagement (n = 153, R2 = 0.3226; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | -0.044 | 0.079 | 0.579 |
| F2 | -0.046 | 0.056 | 0.411 |
| F3 | -0.014 | 0.070 | 0.842 |
| F4 | -0.048 | 0.068 | 0.480 |
| F5 | 0.044 | 0.057 | 0.440 |
| F6 | 0.023 | 0.057 | 0.681 |
| F7 | -0.048 | 0.070 | 0.499 |
| F8 | 0.013 | 0.059 | 0.824 |
| F9 | 0.058 | 0.076 | 0.447 |
| F10 | -0.004 | 0.065 | 0.955 |
| F11 | 0.118 | 0.091 | 0.194 |
| F12 | 0.118 | 0.083 | 0.158 |
| curiosity_gap | 0.073 | 0.064 | 0.251 |
| outrage | 0.040 | 0.056 | 0.475 |
| n_tokens | -0.030 | 0.053 | 0.563 |


Hit concentration: Gini 0.3407, top-10 % share 28.5%, power-law tail not supported vs lognormal (LR = -1.5875, p = 0.1124).


Lexical diversity: Heaps' beta (1,500 tokens) 0.7885, Zipf 0.7687, formulaic titles 9.1503 per 100, mean length 14.9869 tokens.
