...
| F3: Labeled live/formulaic headline (LIVE:, BREAKING:, colon labels) | 61.1 | 47.7 | -0.2 | -0.3 |
...
Nearest style neighbors: @ChadPrather1 [right]; @FreshFitMiami [right]; @RubinReport [right]; @OfficialSaharTV [right]; @GrahamAllen [right]

Nearest topic neighbors: @TheMajorityReport [left]; @SecularTalk [left]; @thomhartmann [left]; @chriscuomo [left]; @franifio [left]
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-01 | 16 | 0.72 | 0.55 | 0.05 | 0.34 | 0.65 | -1.15 | 0.04 | 0.13 | -0.44 | 0.19 | -0.06 | -0.06 | 0.00 | 0.81 | 0.00 |
| 2026-02 | 17 | -0.39 | 1.57 | -0.32 | -0.56 | 1.32 | -0.39 | -0.26 | -0.60 | -1.57 | 0.61 | 0.37 | 0.21 | 0.00 | 0.94 | 0.00 |
| 2026-03 | 18 | 0.39 | 0.35 | -0.21 | 0.13 | -0.32 | -0.35 | -0.49 | -0.04 | -1.46 | 0.12 | 1.17 | -1.32 | 0.00 | 0.83 | 0.00 |
| 2026-04 | 19 | -0.33 | 1.43 | -0.17 | -0.17 | -0.25 | -0.36 | 0.01 | 0.33 | -1.09 | -0.10 | 0.62 | -1.89 | 0.00 | 0.84 | 0.00 |
| 2026-05 | 19 | 1.34 | 0.82 | -0.18 | -0.08 | -0.14 | -0.23 | -0.67 | -0.54 | -0.95 | -0.53 | 1.30 | -0.90 | 0.00 | 0.79 | 0.00 |
| 2026-06 | 16 | -0.17 | 0.03 | -0.28 | 0.11 | -0.37 | 0.50 | -0.39 | -0.33 | -1.17 | 0.01 | 0.60 | -0.11 | 0.00 | 1.00 | 0.00 |
| 2026-07 | 18 | 0.32 | 0.89 | -0.10 | 0.61 | 0.59 | -0.48 | -0.31 | -0.46 | -1.13 | -0.62 | 0.58 | -0.34 | 0.00 | 0.89 | 0.00 |
| 2026-08 | 22 | 0.65 | 0.59 | -0.46 | -0.16 | 0.05 | -0.73 | -0.75 | 0.05 | -1.22 | -0.33 | 1.56 | 0.41 | 0.00 | 0.73 | 0.00 |


Engagement (n = 154, R2 = 0.2612; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | 0.021 | 0.110 | 0.852 |
| F2 | -0.090 | 0.075 | 0.231 |
| F3 | -0.071 | 0.073 | 0.334 |
| F4 | -0.008 | 0.069 | 0.912 |
| F5 | 0.013 | 0.069 | 0.853 |
| F6 | -0.056 | 0.075 | 0.454 |
| F7 | 0.054 | 0.067 | 0.416 |
| F8 | -0.053 | 0.069 | 0.440 |
| F9 | -0.020 | 0.075 | 0.792 |
| F10 | 0.021 | 0.074 | 0.776 |
| F11 | -0.097 | 0.104 | 0.352 |
| F12 | -0.011 | 0.075 | 0.884 |
| curiosity_gap | 0.079 | 4.190 | 0.985 |
| outrage | 0.096 | 0.075 | 0.199 |
| n_tokens | 0.083 | 0.092 | 0.366 |


Hit concentration: Gini 0.4454, top-10 % share 37.4%, power-law tail not supported vs lognormal (LR = -0.1948, p = 0.8456).


Lexical diversity: Heaps' beta (1,500 tokens) 0.847, Zipf 0.6698, formulaic titles 2.5974 per 100, mean length 11.8247 tokens.


## streams

Titles: 35 rows, 35 unique (repeat share 0.0%); LOW-N (not ranked); political share 100.0%.
...
| F3: Labeled live/formulaic headline (LIVE:, BREAKING:, colon labels) | None | None | -0.7 | -0.2 |
...
Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 40.0 per 100, mean length 8.4857 tokens.
