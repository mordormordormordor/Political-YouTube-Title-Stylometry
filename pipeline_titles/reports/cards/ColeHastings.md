...
Channel group: **right** (title-leaning score, document 14) · organization: Cole Hastings · clipper: no · platform: youtube · subscribers: 879000.0


## videos

Titles: 30 rows, 30 unique (repeat share 0.0%); LOW-N (not ranked); political share 93.3%.


Top topics: Gen Z and Generational Issues (53.3%); AI and Political Implications (10.0%); Gaming Industry and Culture (6.7%); Books and Cultural Commentary (6.7%); Shocking Events and Reactions (3.3%)


| dimension | percentile (topic-controlled) | percentile (raw) | score | group median |
|---|---|---|---|---|
| F1: Positive tone vs outrage (shock words, violence verbs, negative sentiment) | None | None | -0.2 | 0.2 |
| F2: +has_finite_verb +present_tense +verb_share +past_tense | None | None | -1.4 | 0.1 |
...
| F11: +n_chars +vader_pos +nominalisation +n_org | None | None | -0.9 | -0.2 |
...
Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 50.0 per 100, mean length 5.6667 tokens.
