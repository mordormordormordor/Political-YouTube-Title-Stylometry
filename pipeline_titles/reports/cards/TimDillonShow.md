...
Titles: 68 rows, 68 unique (repeat share 0.0%); ranked; political share 88.2%.


Top topics: Political Commentary and Interviews (19.1%); Epstein Files Political Connections (5.9%); Israel-Palestine Conflict Media (4.4%); ICE Protests and Shootings (2.9%); Wildfires and Firefighters Response (2.9%)
...
| F7: Descriptive news prose vs title-case (nouns, adjectives, places) | 10.0 | 7.1 | -1.1 | -0.1 |
| F8: Numeric and dated (digits, years) | 72.4 | 85.4 | 0.0 | 0.0 |
| F9: ALL-CAPS shouting | 6.3 | 13.8 | -0.9 | -0.4 |
| F10: Quoted speech | 3.3 | 7.9 | -1.0 | -0.1 |
| F11: Long, upbeat, abstract (length, positive words, nominalisations) | 63.6 | 59.0 | 0.0 | -0.1 |
| F12: Modal and future speculation (will, could, we) | 26.8 | 23.0 | -0.4 | -0.0 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-04 | 19 | 0.91 | -1.73 | -0.73 | 0.51 | -0.26 | 0.30 | -1.21 | -0.22 | -0.73 | -1.05 | -0.83 | 0.08 | 0.00 | 0.26 | 0.00 |


Engagement: n < 100 titles with views, not estimated.


Lexical diversity: Heaps' beta (1,500 tokens) None, Zipf None, formulaic titles 58.8235 per 100, mean length 6.8676 tokens.
