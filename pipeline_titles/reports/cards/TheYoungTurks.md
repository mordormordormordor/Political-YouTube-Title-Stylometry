...
Titles: 2,710 rows, 2,706 unique (repeat share 0.1%); ranked; political share 93.0%.


Top topics: Morning News Headlines (13.0%); Israel and Palestine Conflict (10.6%); Damage and Injury Reports (6.5%); Political Breakfast Shows (6.1%); Members Only Bonus Shows (4.9%)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-01 | 315 | -0.16 | -0.85 | -0.25 | -0.24 | -0.12 | -0.33 | -0.53 | -0.20 | 0.06 | -0.45 | -0.51 | -0.43 | 0.03 | 0.56 | 0.00 |
| 2026-02 | 309 | -0.26 | -0.53 | -0.31 | -0.31 | -0.10 | -0.28 | -0.49 | -0.41 | -0.22 | -0.56 | -0.44 | -0.40 | 0.02 | 0.57 | 0.00 |
| 2026-03 | 335 | -0.29 | -0.62 | -0.35 | -0.37 | -0.12 | -0.29 | -0.63 | -0.50 | -0.30 | -0.73 | -0.60 | -0.39 | 0.01 | 0.56 | 0.00 |
...
Engagement (n = 1836, R2 = 0.2198; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | -0.026 | 0.026 | 0.318 |
| F2 | 0.029 | 0.027 | 0.279 |
| F3 | 0.024 | 0.024 | 0.316 |
| F4 | 0.018 | 0.028 | 0.523 |
| F5 | -0.039 | 0.028 | 0.162 |
| F6 | 0.050 | 0.028 | 0.070 |
| F7 | -0.051 | 0.026 | 0.052 |
| F8 | -0.023 | 0.025 | 0.354 |
| F9 | 0.061 | 0.026 | 0.018 |
| F10 | -0.063 | 0.023 | 0.007 |
| F11 | 0.001 | 0.029 | 0.987 |
| F12 | 0.007 | 0.028 | 0.791 |
| curiosity_gap | 0.048 | 0.028 | 0.086 |
| outrage | 0.049 | 0.026 | 0.062 |
| humor | 0.007 | 0.045 | 0.878 |
| n_tokens | 0.025 | 0.027 | 0.362 |


Hit concentration: Gini 0.5357, top-10 % share 39.9%, power-law tail not supported vs lognormal (LR = -1.9673, p = 0.0491).


Lexical diversity: Heaps' beta (1,500 tokens) 0.8083, Zipf 0.8013, formulaic titles 48.5588 per 100, mean length 6.1574 tokens.


## streams

Titles: 423 rows, 403 unique (repeat share 4.7%); ranked; political share 98.0%.


Top topics: Israel and Palestine Conflict (16.1%); Trump and Iran War Negotiations (6.7%); Tucker Carlson Political Commentary (5.2%); Iran political unrest (3.0%); JD Vance and Trump Political Drama (3.0%)
...
| F6: Person-centred (named people) | 53.2 | 53.2 | 0.3 | 0.7 |
...
Hooks / formats (share of titles; channel-group mean in brackets): curiosity_gap 3.7% (2.6%); outrage 77.2% (62.7%); humor 0.0% (0.1%); question 13.4% (11.3%); breaking_live 13.9% (17.4%); episode_show 0.0% (6.2%); interview_guest 17.4% (18.4%); reaction 2.2% (1.4%); confrontation 12.7% (15.4%); listicle 0.0% (0.0%); howto_explainer 4.2% (2.8%)


Nearest style neighbors: @TheDonLemonShow [left]; @franifio [left]; @NewsmaxTV [right]; @underthedesknews [left]; @rolandsmartin [left]

Nearest topic neighbors: @DueDissidence [left]; @OwenReport [left]; @thejimmydoreshow [neutral]; @TheMajorityReport [left]; @timesofindia [left]
...
| 2026-09* | 18 | -1.36 | -0.64 | -0.47 | -0.59 | -0.65 | -0.50 | -0.87 | -0.27 | -1.01 | -0.15 | 0.49 | 0.19 | 0.00 | 1.00 | 0.00 |


Engagement (n = 224, R2 = 0.3857; log views per within-creator SD, month + topic controls):

| predictor | coef_per_sd | se | p |
|---|---|---|---|
| F1 | -0.013 | 0.057 | 0.815 |
| F2 | 0.031 | 0.057 | 0.592 |
| F3 | 0.211 | 0.079 | 0.007 |
| F4 | 0.056 | 0.045 | 0.216 |
| F5 | -0.026 | 0.035 | 0.452 |
| F6 | 0.066 | 0.053 | 0.216 |
| F7 | 0.003 | 0.051 | 0.948 |
| F8 | -0.059 | 0.040 | 0.143 |
| F9 | -0.057 | 0.049 | 0.250 |
| F10 | 0.068 | 0.052 | 0.190 |
| F11 | 0.015 | 0.055 | 0.786 |
| F12 | 0.029 | 0.040 | 0.466 |
| curiosity_gap | -0.011 | 0.048 | 0.816 |
| outrage | 0.020 | 0.054 | 0.710 |
| n_tokens | -0.087 | 0.063 | 0.164 |


Hit concentration: Gini 0.3579, top-10 % share 29.9%, power-law tail not supported vs lognormal (LR = -1.9109, p = 0.056).


Lexical diversity: Heaps' beta (1,500 tokens) 0.7858, Zipf 0.6745, formulaic titles 40.4467 per 100, mean length 10.1266 tokens.
